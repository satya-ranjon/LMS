  ...
  return (
    <div className="py-48  ">
      <div className="grid grid-cols-1 lg:grid-cols-2  gap-12 relative">
        ...
        {/* Card Two  */}
        <div
          style={{ backgroundImage: 'url("./diplomacardbg.png")' }}
          className=" bg-cover bg-no-repeat bg-center w-full border-[1px] border-lime-400 rounded-xl relative overflow-hidden h-[500px] xl:h-[500px] p-14">
